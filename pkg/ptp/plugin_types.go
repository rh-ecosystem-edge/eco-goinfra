...
//nolint:revive // Plugin type names match the linuxptp-daemon plugin names.
const (
...
// InterfacePin is a string type that represents common pin names for Intel plugins.
// For E810, valid values are SMA1, SMA2, U.FL1, or U.FL2.
