...
func (in *BootModuleConfigList) DeepCopyInto(out *BootModuleConfigList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]BootModuleConfig, len(*in))
		for i := range *in {
...
func (in *BootModuleConfigStatus) DeepCopy() *BootModuleConfigStatus {
	...
	out := new(BootModuleConfigStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DeviceClassSpec) DeepCopyInto(out *DeviceClassSpec) {
	*out = *in
	if in.Selectors != nil {
		...
		*out = make([]resourcev1.DeviceSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Config != nil {
		...
		*out = make([]resourcev1.DeviceClassConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ModuleBuildSignConfigList) DeepCopyInto(out *ModuleBuildSignConfigList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ModuleBuildSignConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ModuleBuildSignConfigList) DeepCopy() *ModuleBuildSignConfigList {
	...
	out := new(ModuleBuildSignConfigList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModuleBuildSignConfigSpec) DeepCopyInto(out *ModuleBuildSignConfigSpec) {
	*out = *in
	if in.Images != nil {
		...
		*out = make([]ModuleBuildSignSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ModuleBuildSignConfigSpec) DeepCopy() *ModuleBuildSignConfigSpec {
	...
	out := new(ModuleBuildSignConfigSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModuleBuildSignConfigStatus) DeepCopyInto(out *ModuleBuildSignConfigStatus) {
	*out = *in
	if in.Images != nil {
		in, out := &in.Images, &out.Images
		*out = make([]BuildSignImageState, len(*in))
		copy(*out, *in)
	}
}
...
func (in *ModuleBuildSignConfigStatus) DeepCopy() *ModuleBuildSignConfigStatus {
	...
	out := new(ModuleBuildSignConfigStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModuleBuildSignSpec) DeepCopyInto(out *ModuleBuildSignSpec) {
	*out = *in
	in.ModuleImageSpec.DeepCopyInto(&out.ModuleImageSpec)
}
...
func (in *ModuleImagesConfigList) DeepCopyInto(out *ModuleImagesConfigList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ModuleImagesConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ModuleImagesConfigList) DeepCopy() *ModuleImagesConfigList {
	...
	out := new(ModuleImagesConfigList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModuleImagesConfigSpec) DeepCopyInto(out *ModuleImagesConfigSpec) {
	*out = *in
	if in.Images != nil {
		in, out := &in.Images, &out.Images
		*out = make([]ModuleImageSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ImageRebuildTriggerGeneration != nil {
		in, out := &in.ImageRebuildTriggerGeneration, &out.ImageRebuildTriggerGeneration
		*out = new(int)
		**out = **in
	}
	if in.Tolerations != nil {
...
func (in *ModuleImagesConfigSpec) DeepCopy() *ModuleImagesConfigSpec {
	...
	out := new(ModuleImagesConfigSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ModuleImagesConfigStatus) DeepCopyInto(out *ModuleImagesConfigStatus) {
	*out = *in
	if in.ImagesStates != nil {
		in, out := &in.ImagesStates, &out.ImagesStates
		*out = make([]ModuleImageState, len(*in))
		copy(*out, *in)
	}
	if in.ImageRebuildTriggerGeneration != nil {
		in, out := &in.ImageRebuildTriggerGeneration, &out.ImageRebuildTriggerGeneration
...
func (in *ModuleImagesConfigStatus) DeepCopy() *ModuleImagesConfigStatus {
	...
	out := new(ModuleImagesConfigStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeModulesConfigList) DeepCopyInto(out *NodeModulesConfigList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NodeModulesConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeModulesConfigSpec) DeepCopyInto(out *NodeModulesConfigSpec) {
	*out = *in
	if in.Modules != nil {
		...
		*out = make([]NodeModuleSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeModulesConfigStatus) DeepCopyInto(out *NodeModulesConfigStatus) {
	*out = *in
	if in.Modules != nil {
		in, out := &in.Modules, &out.Modules
		*out = make([]NodeModuleStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeModulesConfigStatus) DeepCopy() *NodeModulesConfigStatus {
	...
	out := new(NodeModulesConfigStatus)
	in.DeepCopyInto(out)
	return out
}
