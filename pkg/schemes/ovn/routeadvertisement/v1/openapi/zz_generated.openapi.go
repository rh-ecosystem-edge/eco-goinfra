...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		v1.RouteAdvertisements{}.OpenAPIModelName():                       schema_pkg_crd_routeadvertisements_v1_RouteAdvertisements(ref),
		v1.RouteAdvertisementsList{}.OpenAPIModelName():                   schema_pkg_crd_routeadvertisements_v1_RouteAdvertisementsList(ref),
		v1.RouteAdvertisementsSpec{}.OpenAPIModelName():                   schema_pkg_crd_routeadvertisements_v1_RouteAdvertisementsSpec(ref),
		v1.RouteAdvertisementsStatus{}.OpenAPIModelName():                 schema_pkg_crd_routeadvertisements_v1_RouteAdvertisementsStatus(ref),
...
func schema_pkg_crd_routeadvertisements_v1_RouteAdvertisements(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RouteAdvertisements is the Schema for the routeadvertisements API",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.RouteAdvertisementsSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.RouteAdvertisementsStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1.RouteAdvertisementsSpec{}.OpenAPIModelName(), v1.RouteAdvertisementsStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_routeadvertisements_v1_RouteAdvertisementsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RouteAdvertisementsList contains a list of RouteAdvertisements",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1.RouteAdvertisements{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1.RouteAdvertisements{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_routeadvertisements_v1_RouteAdvertisementsSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"targetVRF": {
						SchemaProps: spec.SchemaProps{
							Description: "targetVRF determines which VRF the routes should be advertised in.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"networkSelectors": {
						SchemaProps: spec.SchemaProps{
							Description: "networkSelectors determines which network routes should be advertised. Only ClusterUserDefinedNetworks and the default network can be selected.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(types.NetworkSelector{}.OpenAPIModelName()),
									},
								},
							},
						},
					...
					"nodeSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "nodeSelector limits the advertisements to selected nodes. This field follows standard label selector semantics.",
							Default:     map[string]interface{}{},
					...
					"frrConfigurationSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "frrConfigurationSelector determines which FRRConfigurations will the OVN-Kubernetes driven FRRConfigurations be based on. This field follows standard label selector semantics.",
							Default:     map[string]interface{}{},
							Ref:         ref(metav1.LabelSelector{}.OpenAPIModelName()),
						},
					},
				...
				Required: []string{"networkSelectors", "nodeSelector", "frrConfigurationSelector"},
			},
		},
		Dependencies: []string{
			types.NetworkSelector{}.OpenAPIModelName(), metav1.LabelSelector{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_routeadvertisements_v1_RouteAdvertisementsStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RouteAdvertisementsStatus defines the observed state of RouteAdvertisements. It should always be reconstructable from the state of the cluster and/or outside world.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "status is a concise indication of whether the RouteAdvertisements resource is applied with success.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "conditions is an array of condition objects indicating details about status of RouteAdvertisements object.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
