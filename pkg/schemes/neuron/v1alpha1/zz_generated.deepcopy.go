...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageRepoSecret) DeepCopyInto(out *ImageRepoSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageRepoSecret.
func (in *ImageRepoSecret) DeepCopy() *ImageRepoSecret {
	if in == nil {
		return nil
	}
	out := new(ImageRepoSecret)
