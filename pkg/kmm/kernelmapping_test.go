...
func TestNewLiteralKernelMappingBuilder(t *testing.T) {
	testCases := []struct {
		...
		{
			literal:       "4.18.0-372.32.1.el8_6.x86_64",
			expectedError: "",
		},
		{
			literal:       "",
...
func TestWithContainerImage(t *testing.T) {
	testCases := []struct {
		...
		{
			image:         "registry.example.com/driver:latest",
			expectedError: "",
		},
		{
			image:         "",
...
func TestWithSign(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			filesToSign:   []string{"/lib/modules/mod1.ko", "/lib/modules/mod2.ko"},
			expectedError: "",
		},
		{
			certSecret:    "",
...
func TestWithInTreeModulesToRemove(t *testing.T) {
	testCases := []struct {
		...
		{
			existingModulesList: []string{"i915", "nouveau", "amdgpu"},
			expectedError:       "",
		},
		{
			existingModulesList: []string{},
