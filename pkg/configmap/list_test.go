...
func TestList(t *testing.T) {
	...
	testhelper.NewNamespacedListTestConfig[corev1.ConfigMap, Builder](
...
func TestListInAllNamespaces(t *testing.T) {
	...
	testhelper.NewListTestConfig[corev1.ConfigMap, Builder](
		func(apiClient *clients.Settings, _ ...runtimeclient.ListOptions) ([]*Builder, error) {
			return ListInAllNamespaces(apiClient)
		},
		corev1.AddToScheme,
		configMapGVK,
	).ExecuteTests(t)
